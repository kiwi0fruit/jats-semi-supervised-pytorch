...
"FZA4" latents have some interpretation in accordance with the framework of existing interpretations about psychological traits (see above) but this interpretation is somewhat lacking. This is mostly because framework of existing interpretations uses non-independant observables but the model tries to learn independent latents.
